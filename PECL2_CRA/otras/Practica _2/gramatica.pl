...
%Oracion Coordinada
  o_coordinada(oc(O1,Conj,O2))-->oracion(O1),conjuncion(Conj),oracion(O2).
  
%Oracion Compuesta
   o_compuesta(ocm(O))-->oracion(O).
  %o_compuesta(ocm(GN,GV))-->g_nominal(GN),g_verbal(GV).
  %o_compuesta(ocm(OC1,Conj,O))-->o_coordinada(OC1),conjuncion(Conj),oracion(O).
  o_compuesta(ocm(OC1,Conj,OC2))-->o_coordinada(OC1),conjuncion(Conj),o_coordinada(OC2).
...
% Grupo verbal
  ...
  g_verbal(gv(OR,V,GAdj))-->o_relativo(OR),verbo(V),g_adjetival(GAdj).
  %g_verbal(gv(OR,V,S))--> o_relativo(OR),verbo(V),sub(GN).
